<div class="page-single">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Pago&act={{act}}&cod={{paymentCod}}"
            method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="paymentCod" id="paymentCod"
                    placeholder="Forma de Pago" value="{{paymentCod}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Forma de Pago Español</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="paymentDscES" id="paymentDscES"
                    placeholder="Nombre de Forma de Pago" value="{{paymentDscES}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Forma de Pago Ingles</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="paymentDscEN" id="paymentDscEN"
                    placeholder="Nombre de Forma de Pago" value="{{paymentDscEN}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Libreria</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="paymentLib" id="paymentLib"
                    placeholder="Nombre de Libreria" value="{{paymentLib}}" {{readonly}}>
            </div>
