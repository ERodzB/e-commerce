    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Modulo&act={{act}}&cod={{mdlCod}}" method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="mdlCod" id="mdlCod"
                    placeholder="Codigo de Modulo" value="{{mdlCod}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="mdlDscES">Descripcion del Modulo Español</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="mdlDscES" id="mdlDscES"
                    placeholder="Descripcion de Modulo" value="{{mdlDscES}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="mdlDscEN">Descripcion del Modulo Ingles</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="mdlDscEN" id="mdlDscEN"
                    placeholder="Descripcion de Modulo" value="{{mdlDscEN}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <label for="mdlState">Estado</label><br>
                <select class="col-s-12 col-m-11 col-12 no-padding" name="mdlState" id="mdlState" {{if readonly}}
                    readonly="readonly" disabled {{endif readonly}}>
                    {{foreach states}}
            ...
            <div class="single-input row">
                ...
                <select class="col-s-12 col-m-11 col-12 no-padding" name="mdlClass" id="mdlClass" {{if readonly}}
                    readonly="readonly" disabled {{endif readonly}}>
                    {{foreach class}}
