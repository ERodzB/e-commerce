<div class="page-single">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left"
            action="index.php?page=Variation&act={{act}}&cod={{variationCod}}&prdCod={{prdCod}}" method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="variationPrice" id="variationPrice"
                    placeholder="Precio" value="{{prdPrice}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Porciones a Ofrecer</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="variationQuantity"
                    id="variationQuantity" placeholder="Porciones" value="{{prdQuantity}}" {{readonly}}>
            </div>
