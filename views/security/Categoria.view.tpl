<div class="page-single">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Categoria&act={{act}}&cod={{catCod}}"
            method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" disabled readonly="readonly" type="text"
                    name="catCod" id="catCod" placeholder="Codigo de Usuario" value="{{catCod}}" {{readonly}}>
            </div>
            {{endif readonly}}
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Categoria Español</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="catDscES" id="catDscES"
                    placeholder="Nombre de Categoria" value="{{catDscES}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
            ...
            <div class="single-input row">
                ...
                <select class="col-s-12 col-m-11 col-12 no-padding" name="catState" id="catState" {{if readonly}}
