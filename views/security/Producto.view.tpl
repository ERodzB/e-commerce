<div class="page-single" style="height:200vh;">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Producto&act={{act}}&cod={{prdCod}}" method="POST"
            ...
            <div class="single-input row">
                ...
                <select class="col-s-12 col-m-11 col-12 no-padding" name="prdCategory" id="prdCategory" {{if readonly}}
            ...
            <div class="single-input row">
                ...
                <select class="col-s-12 col-m-11 col-12 no-padding" name="prdState" id="prdState" {{if readonly}}
                    readonly="readonly" disabled {{endif readonly}}>
                    {{foreach states}}
            ...
            <div class="single-buttons col-offset-s-2 col-offset-m-4 col-12 {{ifnot updating}}col-offset-2 {{endifnot updating}}{{if updating}}col-offset-1 {{endif updating}}no-padding">
                {{if updating}} <button class="button-3 col-offset-" type="submit" id="btnVariaciones">Añadir
                    Variaciones</button>&nbsp; {{endif updating}}
