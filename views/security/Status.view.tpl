<div class="page-single">
    ...
    <div class="row single-form col-s-10 col-m-6 col-4 col-offset-s-1 col-offset-m-3 col-offset-4 no-padding">
        ...
        <form class="col-s-12 no-padding left" action="index.php?page=Status&act={{act}}&cod={{statusCod}}"
            method="POST">
            ...
            <div class="single-input row">
                ...
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="statusCod" id="statusCod"
                    placeholder="Codigo de Status" value="{{statusCod}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Status Español</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="statusDscES" id="statusDscES"
                    placeholder="Nombre de Status" value="{{statusDscES}}" {{readonly}}>
            </div>
            <div class="single-input row">
                <br>
                <label class="left" for="text">Nombre de Status Ingles</label><br>
                <input class="col-s-12 col-m-11 col-12 no-padding" type="text" name="statusDscEN" id="statusDscEN"
                    placeholder="Nombre de Status" value="{{statusDscEN}}" {{readonly}}>
            </div>
