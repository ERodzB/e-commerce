    ...
    <header>
        <nav id="menu-barra" class=" ">
            ...
            <ul class="col-s-12 col-m-7 col-12 col-l-6 nav-links no-margin center">
                <li class="button-1"><a href="#slide"><i class="fa fa-bars" aria-hidden="true"></i></a></li>
            </ul>
            <ul class="slide col-s-12 col-m-4 col-2 center no-padding">
                ...
                {{endif notifnum}}
                <li><a class="hover" href="index.php?page=cartL"><i class="fa fa-shopping-cart"
                            aria-hidden="true"></i>&nbsp; {{cartItems}}</a></li>
                <li><a class="hover" href="index.php?page=storeL"><i
                            class="fas fa-prescription-bottle-alt"></i>&nbsp;Medicamentos</a></li>
                {{foreach appmenu}}
                <li><a href="index.php?page={{mdlCod}}">{{mdlDsc}}</a></li>
                {{endfor appmenu}}
                <li class="logout"><a href="index.php?page=logout">Cerrar Sesión <i class="fas fa-sign-out-alt"></i></a>
                </li>
            </ul>
        </nav>
    </header>
